...
import com.dindong.dingdong.presentation.store.GroupBuyListDialog;
...
public class SubjectDetailActivity extends BaseActivity {
    ...
    public class Presenter implements BaseViewAdapter.Presenter, GroupBuyPresenter {
         ...
         * 更多团购
         */
        public void onMoreGroupBuy() {
            if (IsEmpty.list(groupBuys))
                return;
            new GroupBuyListDialog(SubjectDetailActivity.this, groupBuys, new OnConfirmListener<GroupBuyListDialog, GroupBuy>() {
                @Override
                public void onConfirm(GroupBuyListDialog o, GroupBuy data) {
                    o.dismiss();
                    onGroupBuyClick(data);
                }
            }).show();
        }
