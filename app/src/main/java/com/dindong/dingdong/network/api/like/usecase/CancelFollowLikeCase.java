...
public class CancelFollowLikeCase extends BaseUseCase<LikeServiceApi> {
  private LikeEntityType likeEntityType;
  private String entityId;

  public CancelFollowLikeCase(LikeEntityType likeEntityType, String entityId) {
  ...
  protected Observable buildCase() {
    return createConnection().cancelFollowLike(likeEntityType, entityId);
  }
}
