...
/**
 * Created by wangcong on 2017/4/28.
 * <p>
 * 阴影布局
 */
...
public class ShadowLayout extends FrameLayout {
  ...
  private void initAttributes(Context context, AttributeSet attrs) {
    ...
    try {
      mCornerRadius = attr.getDimension(R.styleable.ShadowLayout_sl_cornerRadius,
          DensityUtil.dip2px(getContext(), DefParam.DEFAULT_CORNER_RADIUS));
      mShadowRadius = attr.getDimension(R.styleable.ShadowLayout_sl_shadowRadius,
          DensityUtil.dip2px(getContext(), DefParam.DEFAULT_SHADOW_RADIUS));
      mDx = attr.getDimension(R.styleable.ShadowLayout_sl_dx,
          DensityUtil.dip2px(getContext(), DefParam.DEFAULT_DX));
      mDy = attr.getDimension(R.styleable.ShadowLayout_sl_dy,
          DensityUtil.dip2px(getContext(), DefParam.DEFAULT_DY));
  ...
  private static class DefParam {
    static final int DEFAULT_CORNER_RADIUS = 2;
    static final int DEFAULT_SHADOW_RADIUS = 2;
    static final int DEFAULT_DX = 2;
    static final int DEFAULT_DY = 2;
  }
}
